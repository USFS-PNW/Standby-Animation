...
namespace StandByAnimation
    ...
    public partial class CircularIndeterminateProgress : UserControl
        ...
        const int               MAXIMUM_CIRCLES_COUNT = 30;
        const int               MINIMUM_CIRCLES_COUNT = 20;
        const int               DEFAULT_CIRCLES_COUNT = 20;

        const int               MAXIMUM_CONTROL_WIDTH_HEIGHT = 400;
        const int               MINIMUM_CONTROL_WIDTH_HEIGHT = 90;
        const int               DEFAULT_CONTROL_WIDTH_HEIGHT = 90;

        const int               MAXIMUM_INDICATOR_DIAMETER = 100;
        const int               MINIMUM_INDICATOR_DIAMETER = 10;
        const int               DEFAULT_INDICATOR_DIAMETER = 12;

        const int               MAXIMUM_REFRESH_RATE = 200;
        const int               MINIMUM_REFRESH_RATE = 200;
        const int               DEFAULT_REFRESH_RATE = 200;
        
        
        private Color background_color = Color.Transparent;
        private int             circles_count = DEFAULT_CIRCLES_COUNT;
       
        private Color control_color = Color.Transparent;
        ...
        public CircularIndeterminateProgress ( )
            ...
            label1.Left = (int)(this.Width / 2) - (int)(label1.Width / 2);
            label1.Top = (int)(this.Height / 2) - (int)(label1.Height / 2);
            ...
            control_color = Color.Transparent;
            indicator_angle = 0.0F;
            indicator_color = Color.ForestGreen;
;
        ...
        void create_indicator_graphic ( )
            ...
            if ( indicator_graphic.CreateGraphicsBuffer (
                ...
                for ( int i = 0; ( i  < CirclesCount ); i++ )
                    ...
                    color = lighter_color ( color, 0.10F );
